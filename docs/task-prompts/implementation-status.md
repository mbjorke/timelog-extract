...
- `partial`: some deliverables are implemented, but scope/acceptance remains open.
...
| `docs/task-prompts/live-terminal-sandbox-demo-task.md`     | `partial`      | Allowlist contract + deterministic sandbox behavior are implemented, but full hardening/production-grade scope remains open.                        |
...
| `docs/task-prompts/task-traceability-template.md`          | `n/a`          | Template file, not an implementation task.                                                                                                          |
