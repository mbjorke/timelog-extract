...
from core.cli_experiments import run_fixtures
...
def main() -> int:
    ...
    parser.add_argument(
        "--fixtures-dir",
        default="tests/fixtures/experiments",
        help="Directory with experiment fixture json files.",
    )
    parser.add_argument(
        "--out-json",
        default="out/cli-experiments/scorecard.json",
        help="Path to write machine-readable scorecard JSON.",
    )
    parser.add_argument(
        "--out-md",
        default="out/cli-experiments/scorecard.md",
        help="Path to write markdown summary.",
    )
    parser.add_argument(
        "--strict",
        action="store_true",
        help="Exit non-zero when any fixture has a failing threshold.",
    )
