...
| `marketing/` | Marketing drafts (e.g. [DAIS Substack long-form](marketing/dais-substack-article-gittan-v3.md)). |
...
- **Mapping & signals — how to build forward (June 2026)** → [`roadmaps/mapping-signals-continuation-2026-06.md`](roadmaps/mapping-signals-continuation-2026-06.md)
- **Freelance Bridge PR #140 execution log** → [`ideas/freelance-bridge-planning-arc.md`](ideas/freelance-bridge-planning-arc.md)
...
- **Public changelog + downloadable beta (draft, Comms-style)** → [`ideas/changelog-and-beta-distribution-plan.md`](ideas/changelog-and-beta-distribution-plan.md)
...
- **Which task-prompts are actually built** → each spec's own `## Traceability` block (`implementation_status`) is the source of truth; [`task-prompts/implementation-status.md`](task-prompts/implementation-status.md) is a hand-maintained summary and [`generated/feature-inventory.md`](generated/feature-inventory.md) the code-derived view
