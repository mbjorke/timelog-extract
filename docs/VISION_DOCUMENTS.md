...
| `docs/rc-prompts/agent-inline-cli-ux-validation-rc.md` | **RC execution prompt:** priority implementation brief for automatic inline CLI smoke validation during agent-driven development.                                                                                               |
| `docs/rc-prompts/copilot-cli-source-rc.md`             | **RC story:** add first-class GitHub Copilot CLI source detection, collector wiring, doctor visibility, and source-summary reporting.                                                                                          |
| `docs/rc-prompts/live-terminal-sandbox-demo-rc.md`     | **RC execution prompt:** secure live terminal demo rollout with allowlisted sandbox execution and hardening checklist.                                                                                                         |
