...
class ProjectsAuditTests(unittest.TestCase):
    ...
    def test_anchor_plan_from_audit_only_unanchored(self) -> None:
        ...
        # Explicit low floor + ephemeral opt-in: legacy inventory of all kinds.
    ...
    def test_anchor_plan_default_excludes_ephemeral_and_floors_hits(self) -> None:
        audit = {
            ...
            "options": {},
            "top_signals": [
                {"kind": "host", "value": "other.test", "hits": 25, "anchored": False, "rule_type": "tracked_urls"},
                {"kind": "dir", "value": "project-gamma", "hits": 22, "anchored": False, "rule_type": "match_terms"},
                {"kind": "repo", "value": "acme/gamma", "hits": 21, "anchored": False, "rule_type": "match_terms"},
                {"kind": "branch", "value": "gamma-feature", "hits": 40, "anchored": False, "rule_type": "match_terms"},
                {"kind": "label", "value": "redesign gamma", "hits": 30, "anchored": False, "rule_type": "match_terms"},
                {"kind": "dir", "value": "one-off", "hits": 5, "anchored": False, "rule_type": "match_terms"},
            ],
        }
