...
| **kanin** / **kaninen** | CodeRabbit (mascot = hare) | *Informellt.* “Nu tuggar kaninen igen” = ny review-runda eller många nya kommentarer. (CodeRabbits riktiga kvoter: se [`AGENTS.md`](../../AGENTS.md) → *Review Cadence*.) Ibland en **dikt** i walkthrough — sparas i [`kanin-poems.md`](kanin-poems.md). |
