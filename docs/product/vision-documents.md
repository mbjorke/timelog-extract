...
| `docs/archive/release-scope-0.2.3.md`                 | **Release plan (historical):** must/should/nice scope for the **0.2.3** PyPI-first-upload milestone; linked from `docs/runbooks/versioning.md`.                                                                                       |
