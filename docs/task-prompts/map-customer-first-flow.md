...
Extends [`map-existing-project-and-merge-ux.md`](map-existing-project-and-merge-ux.md)
(GH-222). That work fixes “map to existing project” and merge copy; this spec
defines the **interaction model** map should use going forward.
...
- implementation.pr: https://github.com/mbjorke/timelog-extract/pull/223 (partial; customer-first not in PR)
- implementation.branch: `task/map-customer-first-flow` (proposed)
