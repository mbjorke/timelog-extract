...
class CliHeroSelectionTests(unittest.TestCase):
    ...
    def test_hero_selection_for_search_and_report(self, mock_tree, mock_print_hero):
        ...
        mock_print_hero.assert_called_once_with(unittest.mock.ANY, "search")
        mock_print_hero.reset_mock()
        ...
        mock_print_hero.assert_called_once_with(unittest.mock.ANY, "report")
        mock_print_hero.reset_mock()
