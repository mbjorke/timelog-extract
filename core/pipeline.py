...
def collect_all_events(
    ...
    *,
    ...
    collectors = build_collector_specs_fn(
        ...
        collect_claude_desktop_code=collect_claude_desktop_code,
        ...
        collect_antigravity=collect_antigravity,
        collect_windsurf=collect_windsurf,
        collect_vscode=collect_vscode,
