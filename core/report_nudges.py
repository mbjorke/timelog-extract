...
def build_unanchored_anchors_nudge(
    ...
    *,
    ...
    return (
        ...
        "Run `gittan map` to map repo slugs, session titles, working dirs, and branches interactively "
        "(GitHub repos first: `gittan map --scan-repos`; batch: `gittan projects-audit --write-anchor-plan`)."
    )
