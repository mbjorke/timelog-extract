...
- **GitHub Funding / Sponsors:** The repo includes **`.github/FUNDING.yml`** for the **Sponsor** button metadata. Align listed URLs with live Patreon/Sponsors pages; optional setup flow: [open funding setup for this repo](https://github.com/mbjorke/timelog-extract/new/main?repository_funding=1).
