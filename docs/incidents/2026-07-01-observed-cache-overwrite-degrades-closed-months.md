...
- **Invoiced records: NOT affected.** The authoritative source for closed months is
  ...
  It is intact (e.g. `client-a-2026-03` = 12.00 h). The observed cache is a statusline
...
- The ledger already documented that gittan-tracked CLIENT A March was below the invoiced 12.00 h at
