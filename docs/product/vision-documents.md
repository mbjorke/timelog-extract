...
| `docs/decisions/agent-review-contract.md`              | **Decision (draft):** severity → allowed executor response; CodeRabbit vs Cursor hand-off; pointers to vendor autofix / fix-all / Skills docs.                                                                                  |
